...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2020 at 10:17 PM
...
INSERT INTO `bank_infos` (`id`, `bank_name`, `account_no`, `branch_name`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Brac Bank', '141.101.85442', 'Dhanmondi', 'Active', '2020-07-09 13:17:17', '2020-07-09 13:17:17'),
(2, 'City Bank', '1100345820', 'Mogh Bazar', 'Active', '2020-07-09 13:17:17', '2020-07-09 13:17:17');
...
(4, 'uploads/banners/ZASxPPoWrj8EZWnRBCLjm0C9TIBkp3iLW8UJwfXW.jpeg', '#', 1, 1, '2019-03-12 05:58:23', '2020-06-20 02:39:04'),
(5, 'uploads/banners/iep5gu2wh8DLBdMfxnR6nqDn2CubF2wVYlM8T8gk.jpeg', '#', 1, 1, '2019-03-12 05:58:41', '2020-06-20 02:39:15'),
(6, 'uploads/banners/banner.jpg', 'http://192.168.10.107/shop/public/', 2, 0, '2019-03-12 05:58:52', '2019-09-26 09:26:10'),
(7, 'uploads/banners/banner.jpg', '#', 2, 0, '2019-05-26 05:16:38', '2019-09-26 09:26:11'),
(8, 'uploads/banners/banner.jpg', 'http://', 2, 0, '2019-06-11 05:00:06', '2019-09-26 09:26:12'),
(9, 'uploads/banners/zmQgJfOr2bpFBN7rfk9eRgyISx9jqbDOzw3YaRhZ.jpeg', '#', 1, 1, '2019-06-11 05:00:15', '2020-06-20 02:39:24'),
...
(1, 'Apple', 'uploads/brands/Tx3EkkB9Y5wnBRujAb51jcwVvSkR5350yINr1m9F.png', 1, '2019-03-12 06:05:56', '2019-09-25 11:48:11'),
(2, 'Mojang', 'uploads/brands/6iTwjB67LN9PlR1XEtrE2ITVcfUvyY1Lo4fJk7CS.webp', 1, '2019-03-12 06:06:13', '2020-06-18 06:45:38'),
(3, 'Amazon', 'uploads/brands/Ur1g68DcdTTg3h4I1QnNB0pSUxQYBr2QjvTQM6yx.png', 1, '2019-09-25 11:49:31', '2020-06-18 13:00:00'),
(4, 'Xbox Live', 'uploads/brands/Vo1RwTaGRYvIDue4fFxZxYU3WBBGF5zhu7BlAom5.webp', 1, '2019-09-25 11:50:23', '2020-06-18 13:00:00'),
(5, 'Cloud Comet', 'uploads/brands/q2Ey3hzDlDXzIcLBEhPbo0l6LWc2gbD6c70cbQVT.jpeg', 0, '2020-06-17 00:14:10', '2020-06-17 00:14:10'),
(6, 'Garena', 'uploads/brands/zohHmmyAIY5hQ6FmFKqpicccQEHeZIn3pEfyPPIP.gif', 1, '2020-06-18 01:00:08', '2020-06-18 13:00:00'),
(7, 'Steam', 'uploads/brands/x5OEN9Swb8Nc3DtjLAPFOzPrh1Y9TYdjxsntxcba.jpeg', 1, '2020-06-18 01:02:39', '2020-06-18 13:00:00'),
(8, 'Roblox Corporation', 'uploads/brands/n94fcqqMeyv7n8LVbq9IpJIO9rrN2Tpwm6lgWmO5.jpeg', 0, '2020-06-18 01:04:49', '2020-06-18 01:04:49'),
(9, 'Blizzard Entertainment', 'uploads/brands/dYSrhIV6c0IATcgELPqwFRHmIx5pm9X0oVxLQMLj.jpeg', 0, '2020-06-18 01:06:30', '2020-06-18 01:06:30'),
(10, 'Valve', 'uploads/brands/NmzlwIE1llisXnb4O6ET6ZW37sWhBllRBiXjR9GZ.jpeg', 1, '2020-06-18 01:07:48', '2020-06-20 02:36:07'),
(11, 'Karma Koin', 'uploads/brands/icyiGGIxKHhiai6BFBqzKbx0kHp7YDXABSEwZTel.jpeg', 1, '2020-06-18 01:09:17', '2020-06-20 02:36:07'),
(12, 'Tencent Games', 'uploads/brands/mwUCMljHErGUZOVSskHJw43K5ihwplb6bp6BZJqX.jpeg', 0, '2020-06-18 02:24:50', '2020-06-18 02:24:50'),
(13, 'Nintendo', 'uploads/brands/5hXPccYoY8uKfNeKFyV27fby0Q0weeMdBnDU7w1W.png', 0, '2020-06-19 01:02:56', '2020-06-19 01:02:56'),
(14, 'NC Soft', 'uploads/brands/1fVUWhjyzii8uSwtEBJdPQ1NOIL9cpqbu79dt4dQ.webp', 0, '2020-06-19 01:10:37', '2020-06-19 01:10:37'),
(15, 'IMVU', 'uploads/brands/XWgx6ajulbe6KRWfWlF6w2pexCGufgRUD4RXze3Q.png', 0, '2020-06-19 01:12:24', '2020-06-19 01:12:24');
...
(1, 'home_default_currency', '27', '2018-10-16 01:35:52', '2019-09-25 00:20:34'),
(2, 'system_default_currency', '27', '2018-10-16 01:36:58', '2019-09-25 00:20:34'),
...
(9, 'paypal_payment', '1', '2018-10-28 07:45:16', '2019-09-25 11:43:56'),
(10, 'stripe_payment', '1', '2018-10-28 07:45:47', '2019-09-25 11:43:59'),
...
(16, 'sslcommerz_payment', '1', '2019-01-24 09:39:07', '2019-09-25 11:44:02'),
...
(20, 'facebook_login', '1', '2019-02-07 12:51:59', '2019-09-25 23:53:46'),
(21, 'google_login', '1', '2019-02-07 12:52:10', '2019-09-26 08:46:14'),
...
(38, 'wallet_system', '1', '2019-05-19 08:05:44', '2020-07-07 08:55:45'),
...
(1, 'VOUCHER PURCHASE', 'uploads/categories/banner/vlA3V1wIK4hQaOqkiYSV1fIPGi9lSJRq5MIuUO4b.jpeg', 'uploads/categories/icon/t0a6qSsEaGiJl5l7ltV5Qmbcd33IJqLMbPqgiubD.png', 1, 1, '', '', '', '2020-07-06 06:09:05', '2020-07-06 00:09:05'),
(2, 'FLASH TOP UP', 'uploads/categories/banner/04Ju0SuIP9BCQkN1QAvcIQ061EyaNSK2M0YHTakP.jpeg', 'uploads/categories/icon/psNZ1GBaQiDZdxbDnHXMqkY9JpTK8Jg36RqApVm9.png', 1, 1, '', '', '', '2020-07-06 06:09:17', '2020-07-06 00:09:17'),
(3, 'FAVORITE GAMES', 'uploads/categories/banner/S5hJcdBazcmuaBv3nBuSjy1Ro5M5EHqoCqD8okoA.jpeg', 'uploads/categories/icon/rKAPw5rNlS84JtD9ZQqn366jwE11qyJqbzAe5yaA.png', 1, 1, '', '', '', '2020-07-06 06:25:09', '2020-07-06 00:25:09');
...
(27, 'BDT', '৳', 84.00000, 1, 'BDT', '2018-10-09 11:35:08', '2020-06-17 00:04:10');
...
(1, 5, '2020-06-20 01:35:12', '2020-06-20 01:35:12');
...
(1, '5', 'uploads/logo/UeePdCYBqLx7zxeYi0sEs7M12Zuf8epF4EiUff6I.jpeg', 'uploads/admin_logo/vV3AN5IMhfXUwSg8cK66ixtCqmG1OwWVR8izfmKZ.jpeg', 'uploads/admin_login_background/EKQGMY7PeOgJdsAyKkU7eqB84ZHtOlfiZI1M0t91.jpeg', 'uploads/admin_login_sidebar/abCVzPrfueUGjv7imXo3mAfOaZ32wHc01GDCnZR4.jpeg', 'uploads/favicon/JJwAd6x7TYxh3CVKc0EYVofnUbD1agK6eWYddUL9.jpeg', 'GcNet', '250 Hartford Avenue, Bellingham USA', 'GcNet, Digital goods seller.\r\nA digital product is an intangible asset or piece of media that can be sold and distributed repeatedly online without the need to replenish inventory. These products often come in the form of downloadable or streamable files, such as MP3s, PDFs, videos, plug-ins, and templates.', '+113842532009', 'gcnet@gmail.com', 'https://www.facebook.com/gcnet', 'https://www.instagram.com/gcnet', 'https://www.twitter.com/gcnet', 'https://www.youtube.com/gcnet', 'https://www.googleplus.com/gcnet', '2020-07-07 21:02:36', '2020-07-07 15:02:36');
...
(2, 2, '[\"10\"]', 0, '2019-03-12 06:44:54', '2020-06-20 02:36:31'),
(3, 3, '[1]', 0, '2020-06-19 05:56:01', '2020-06-20 02:36:31');
...
(1, 'English', 'en', 0, '2019-01-20 12:13:20', '2020-07-07 13:40:45'),
(3, 'Bangla', 'bd', 0, '2019-02-17 06:35:37', '2020-07-07 13:39:53'),
(4, 'Arabic', 'sa', 1, '2019-04-28 18:34:12', '2020-07-07 13:41:15'),
(5, 'Wales', 'wales', 0, '2020-07-07 13:39:20', '2020-07-07 13:39:20');
...
(1, 'Facebook', 'https://facebook.com/gcnet', '2020-07-07 09:37:55', '2020-07-07 03:37:55'),
(2, 'Twitter', 'https://twitter.com/gcnet', '2020-07-07 09:38:04', '2020-07-07 03:38:04'),
(3, 'Youtube', 'https://youtube.com/gcnet', '2020-07-07 03:37:40', '2020-07-07 03:37:40'),
(4, 'Linkedin', 'https://linkedin.com/gcnet', '2020-07-07 03:38:23', '2020-07-07 03:38:23'),
(5, 'Instagram', 'https://instagram.com/gcnet', '2020-07-07 03:38:49', '2020-07-07 03:38:49');
...
CREATE TABLE `order_details` (
  ...
  `delivery_status` enum('pending','on_review','delivered') COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('debnath.bappe@gmail.com', '$2y$10$I7zxfOH0YQcQsqxCtYZiquv6.gA/ngfsYfgXGtfExGd3X9FUPxHXe', '2019-10-26 23:37:24');
...
(1, 'support_policy', 'T????', '2019-01-22 11:20:54', '2019-01-22 05:13:15'),
(2, 'return_policy', '<!--????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????-->Here is return policy doc<br>', '2019-09-25 07:14:20', '2019-09-25 12:14:20'),
(4, 'seller_policy', 'Here is seller terms and policy doc<br>', '2019-09-25 07:13:57', '2019-09-25 12:13:57'),
(5, 'terms', '????????????????????', '2019-01-29 10:24:42', '0000-00-00 00:00:00'),
(6, 'privacy_policy', '偲????????????', '2019-01-29 10:24:42', '0000-00-00 00:00:00');
...
CREATE TABLE `product_codes` (
  ...
  `category_id` int(11) NOT NULL,
  `brand_id` int(11) NOT NULL,
  `domination` varchar(255) NOT NULL,
  `p_code` varchar(255) NOT NULL,
  `status` enum('ACTIVE','INACTIVE','SOLD','CANCELLED','EXPIRED','PROCESSING') NOT NULL,
...
(1, 'mobile', 8, '2019-11-24 04:56:27', '2020-06-20 03:13:22');
...
(1, 'online coupon,gcnet', 'GcNet Inc', 11, 'https://www.gcnet.com', 'GCNET, Online goods seller.', '2020-07-07 20:45:42', '2020-07-07 14:45:42');
...
(18, 'uploads/sliders/nK2FP2DmHJl78cu0Z4LDkaI44TylN1QNQyDTOTqm.jpeg', 1, '2020-07-07 03:31:14', '2020-07-07 03:31:14'),
(19, 'uploads/sliders/IPmkVEdAxpiWBtTMZkjw7ONkZOadzp7YRhlCjsuD.jpeg', 1, '2020-07-07 03:31:14', '2020-07-07 03:31:14'),
(20, 'uploads/sliders/aspglxvkIJSqTx04B0t5NJC8ZAEcjjuCzyz8dLoy.jpeg', 1, '2020-07-07 03:31:14', '2020-07-07 03:31:14'),
(21, 'uploads/sliders/DNMWGLr70EtJmHPVje6IUWyKwx1103eTZjR5HUjE.jpeg', 1, '2020-07-07 03:31:14', '2020-07-07 03:31:14');
...
INSERT INTO `tickets` (`id`, `user_id`, `subject`, `details`, `viewed`, `created_at`, `updated_at`) VALUES
(1, 5, 'Hello world', 'Hello', 0, '2020-07-09 15:29:37', '2020-07-09 15:29:37');
...
(4, NULL, 'admin', 'GCNET', 'admin@gmail.com', '2019-09-25 00:09:34', '$2y$10$eUKRlkmm2TAug75cfGQ4i.WoUbcJ2uVPqUlVkox.cv4CCyGEIMQEm', 'Fby7UrJiBHd3Cxe2MUfRuC57L2ZHcyo03LuW2Iyf5SEOs7wHRosRkUk2SoDp', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6000.00, '2019-09-25 00:20:34', '2020-07-12 16:18:43'),
(5, NULL, 'customer', 'Amin', 'amin@gmail.com', '2020-06-20 01:06:12', '$2y$10$0dRiU2Swb17fS/9itlYtf.xZOhLi8v/zNe/CGfpybMzuI5YK1k0Oe', 'hrxfQY9ukaFO3O9MGiXRAO15omZg6dPZwrXefLlYjE9SH6ZYyr6yODJ49Wsj', NULL, 'uploads/LtUfnXutE4XD9hYSBdc34kIE6dwHfOZZoBWX2wXE.jpeg', 'Dhanmondi, Dhaka', 'BD', 'Dhaka', '1200', '01717761611', 2700.00, '2020-06-20 01:35:12', '2020-07-12 16:25:12');
...
CREATE TABLE `wallets` (
  ...
  `status` enum('pending','success','cancel','invalid') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `wallets` (`id`, `user_id`, `bank_id`, `amount`, `payment_method`, `payment_details`, `transaction_id`, `status`, `created_at`, `updated_at`) VALUES
(2, 5, 2, 2000.00, 'bank payment', NULL, '234235361351523', 'success', '2020-07-09 15:25:40', '2020-07-12 16:25:12'),
(3, 5, 1, 5000.00, 'bank payment', NULL, '122111122322', 'invalid', '2020-07-10 12:58:43', '2020-07-12 16:18:19'),
(4, 5, 2, 800.00, 'bank payment', NULL, '22001210121003', 'pending', '2020-07-12 16:31:42', '2020-07-12 16:31:42');
