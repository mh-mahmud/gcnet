...
Route::group(['middleware' => ['user', 'verified']], function(){
	...
	Route::post('/bank-recharge', 'WalletController@bank_recharge')->name('wallet.bank.recharge');
...
Route::group(['middleware' => ['auth']], function(){
	...
	Route::post('/products/addcode/','ProductController@addcode')->name('products.addcode');
	Route::post('/products/editcode/','ProductController@editcode')->name('products.editcode');
	// Route::post('/changestatus','ProductController@change_wallet_status')->name('wallet.change.status');

	Route::post('/products/update/{id}','ProductController@update')->name('products.update');
	Route::get('/products/destroy/{id}', 'ProductController@destroy')->name('products.destroy');

	Route::get('/products/destroycode/{id}', 'ProductController@destroycode')->name('products.destroycode');
	...
	Route::post('/products/changecodestatus', 'ProductController@updateCodeStatus')->name('products.changecodestatus');
