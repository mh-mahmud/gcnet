...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('/products/admin/{id}/managecode','ProductController@admin_manage_code')->name('products.admin.managecode');
	...
	// Wallet History
	Route::get('/wallet-history', 'HomeController@wallet_history')->name('admin.wallet.index');
	Route::get('/delete-wallet/{id}', 'HomeController@wallet_delete')->name('admin.wallet.delete');
	Route::post('/wallet/changestatus','HomeController@change_wallet_status')->name('wallet.change.status');
});
