...
class HomeController extends Controller
{
    ...
    public function wallet_history() {
        $history = Wallet::orderBy('created_at', 'desc')->get();
        return view('wallet_history', compact('history'));
    }
    ...
    public function change_wallet_status(Request $request) {
        ...
        if($wallet->save()) {
            ...
            flash(__('Wallet status has been updated successfully'))->success();
    ...
    public function wallet_delete($id) {
        ...
        if(Wallet::destroy($id)){
            flash(__('Records has been deleted successfully'))->success();
            return redirect()->back();
        }
        else{
            flash(__('Something went wrong'))->error();
